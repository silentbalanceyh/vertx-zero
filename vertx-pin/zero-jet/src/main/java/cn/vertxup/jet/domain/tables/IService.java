...
public class IService extends TableImpl<IServiceRecord> {
     ...
     */
    public final TableField<IServiceRecord, String> KEY = createField("KEY", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "「key」- 服务ID");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.NAMESPACE</code>. 「namespace」- 服务所在名空间
     */
    public final TableField<IServiceRecord, String> NAMESPACE = createField("NAMESPACE", org.jooq.impl.SQLDataType.VARCHAR(255), this, "「namespace」- 服务所在名空间");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.NAME</code>. 「name」- 服务名称
     */
    public final TableField<IServiceRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR(255), this, "「name」- 服务名称");
    /**
    ...
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.IS_GRAPHIC</code>. 「isGraphic」- 是否驱动图引擎
     */
    public final TableField<IServiceRecord, Boolean> IS_GRAPHIC = createField("IS_GRAPHIC", org.jooq.impl.SQLDataType.BIT, this, "「isGraphic」- 是否驱动图引擎");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.IN_SCRIPT</code>. 「inScript」- 本次不使用，加载脚本引擎ScriptEngine前置脚本
     */
    public final TableField<IServiceRecord, String> IN_SCRIPT = createField("IN_SCRIPT", org.jooq.impl.SQLDataType.CLOB, this, "「inScript」- 本次不使用，加载脚本引擎ScriptEngine前置脚本");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.OUT_SCRIPT</code>. 「outScript」- 本次不使用，加载脚本引擎ScriptEngine后置脚本
     */
     ...
     */
    public final TableField<IServiceRecord, String> SIGMA = createField("SIGMA", org.jooq.impl.SQLDataType.VARCHAR(32), this, "「sigma」- 统一标识");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<IServiceRecord, String> LANGUAGE = createField("LANGUAGE", org.jooq.impl.SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.ACTIVE</code>. 「active」- 是否启用
     */
    public final TableField<IServiceRecord, Boolean> ACTIVE = createField("ACTIVE", org.jooq.impl.SQLDataType.BIT, this, "「active」- 是否启用");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<IServiceRecord, String> METADATA = createField("METADATA", org.jooq.impl.SQLDataType.CLOB, this, "「metadata」- 附加配置数据");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    public final TableField<IServiceRecord, LocalDateTime> CREATED_AT = createField("CREATED_AT", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "「createdAt」- 创建时间");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.CREATED_BY</code>. 「createdBy」- 创建人
     */
    public final TableField<IServiceRecord, String> CREATED_BY = createField("CREATED_BY", org.jooq.impl.SQLDataType.VARCHAR(36), this, "「createdBy」- 创建人");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    public final TableField<IServiceRecord, LocalDateTime> UPDATED_AT = createField("UPDATED_AT", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "「updatedAt」- 更新时间");
    /**
     * The column <code>DB_ETERNAL.I_SERVICE.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    public final TableField<IServiceRecord, String> UPDATED_BY = createField("UPDATED_BY", org.jooq.impl.SQLDataType.VARCHAR(36), this, "「updatedBy」- 更新人");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.I_SERVICE_NAME, Indexes.I_SERVICE_PRIMARY);
    }
    ...
    public List<UniqueKey<IServiceRecord>> getKeys() {
        return Arrays.<UniqueKey<IServiceRecord>>asList(Keys.KEY_I_SERVICE_PRIMARY, Keys.KEY_I_SERVICE_NAME);
    }
