...
ALTER TABLE X_ACTIVITY
    ADD INDEX IDXM_X_ACTIVITY_MODEL_ID_MODEL_KEY (`MODEL_ID`, `MODEL_KEY`, `ACTIVE`);
ALTER TABLE X_ACTIVITY
    ADD INDEX IDXM_X_ACTIVITY_SIGMA_ACTIVE (`SIGMA`, `ACTIVE`);
ALTER TABLE X_ACTIVITY
    ADD INDEX IDX_X_ACTIVITY_CREATED_AT (`CREATED_AT`);
