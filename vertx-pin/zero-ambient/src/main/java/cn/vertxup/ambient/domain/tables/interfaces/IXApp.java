...
public interface IXApp extends Serializable {
     ...
     */
    public void from(cn.vertxup.ambient.domain.tables.interfaces.IXApp from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IXApp
     */
    public <E extends cn.vertxup.ambient.domain.tables.interfaces.IXApp> E into(E into);
