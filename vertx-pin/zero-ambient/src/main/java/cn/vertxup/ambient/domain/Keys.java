...
public class Keys {
    ...
    public static final UniqueKey<XMessageRecord> KEY_X_MESSAGE_APP_ID = Internal.createUniqueKey(XMessage.X_MESSAGE, DSL.name("KEY_X_MESSAGE_APP_ID"), new TableField[] { XMessage.X_MESSAGE.APP_ID, XMessage.X_MESSAGE.CODE }, true);
    public static final UniqueKey<XMessageRecord> KEY_X_MESSAGE_APP_ID_2 = Internal.createUniqueKey(XMessage.X_MESSAGE, DSL.name("KEY_X_MESSAGE_APP_ID_2"), new TableField[] { XMessage.X_MESSAGE.APP_ID, XMessage.X_MESSAGE.NAME }, true);
    public static final UniqueKey<XMessageRecord> KEY_X_MESSAGE_PRIMARY = Internal.createUniqueKey(XMessage.X_MESSAGE, DSL.name("KEY_X_MESSAGE_PRIMARY"), new TableField[] { XMessage.X_MESSAGE.KEY }, true);
    public static final UniqueKey<XMessageTplRecord> KEY_X_MESSAGE_TPL_APP_ID = Internal.createUniqueKey(XMessageTpl.X_MESSAGE_TPL, DSL.name("KEY_X_MESSAGE_TPL_APP_ID"), new TableField[] { XMessageTpl.X_MESSAGE_TPL.APP_ID, XMessageTpl.X_MESSAGE_TPL.CODE }, true);
    public static final UniqueKey<XMessageTplRecord> KEY_X_MESSAGE_TPL_APP_ID_2 = Internal.createUniqueKey(XMessageTpl.X_MESSAGE_TPL, DSL.name("KEY_X_MESSAGE_TPL_APP_ID_2"), new TableField[] { XMessageTpl.X_MESSAGE_TPL.APP_ID, XMessageTpl.X_MESSAGE_TPL.NAME }, true);
    public static final UniqueKey<XMessageTplRecord> KEY_X_MESSAGE_TPL_PRIMARY = Internal.createUniqueKey(XMessageTpl.X_MESSAGE_TPL, DSL.name("KEY_X_MESSAGE_TPL_PRIMARY"), new TableField[] { XMessageTpl.X_MESSAGE_TPL.KEY }, true);
