...
public class Keys {
    ...
    public static final UniqueKey<XMenuMyRecord> KEY_X_MENU_MY_OWNER = Internal.createUniqueKey(XMenuMy.X_MENU_MY, DSL.name("KEY_X_MENU_MY_OWNER"), new TableField[] { XMenuMy.X_MENU_MY.OWNER, XMenuMy.X_MENU_MY.TYPE, XMenuMy.X_MENU_MY.PAGE, XMenuMy.X_MENU_MY.POSITION, XMenuMy.X_MENU_MY.UI_MENU }, true);
