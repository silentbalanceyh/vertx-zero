    ...
    Future<JsonObject> executeAsync(final JsonObject oldRecord, final JsonObject newRecord,
        ...
        if (changeList.isEmpty()) {
            ...
            if (isValid) {
                 ...
                 */
                final Set<String> confirmFields = this.atom.marker().enabled(EmAttribute.Marker.confirm);
            ...
            return Ux.Jooq.on(XActivityDao.class).insertAsync(activity)
                .compose(inserted -> {
                    ...
                    changeList.forEach(change -> {
                         ...
                         */
                        final Set<String> track = this.atom.marker().enabled(EmAttribute.Marker.track);
