...
final class OxField {
    ...
    static Set<String> ignorePull(final DataAtom atom) {
        final Set<String> fieldSet = toIgnores(atom.marker().disabled(AttributeMarker.track));
        fieldSet.addAll(atom.marker().disabled(AttributeMarker.syncIn));
        return fieldSet;
    }

    static Set<String> ignorePush(final DataAtom atom) {
        return atom.marker().disabled(AttributeMarker.syncOut);
    }
    ...
    static Set<String> ignoreIn(final DataAtom atom) {
        return toIgnores(atom.marker().disabled(AttributeMarker.syncIn));
    }

    static Set<String> ignorePure(final DataAtom atom) {
        return toIgnores(atom.marker().disabled(AttributeMarker.track));
    }
