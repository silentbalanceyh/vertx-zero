    ...
    /*
     {
        "output": "20200510",
        "after-report": {
            "component": "cn.originx.zzbank.migration.ReportTodo",
            "config": {
                "dao": "cn.originx.zzbank.domain.tables.daos.BTicketDao",
                "source": "DYNAMIC",
                "folder": "history"
            }
        },
        "after-restore": {
            "component": "cn.originx.zzbank.migration.RestoreTodo",
            "config": {
                "dao": "cn.originx.zzbank.domain.tables.daos.BTicketDao",
                "source": "DYNAMIC",
                "folder": "history"
