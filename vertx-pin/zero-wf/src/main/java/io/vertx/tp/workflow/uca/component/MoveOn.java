...
public interface MoveOn extends Behaviour {
    ...
    static Future<MoveOn> event(final Task task) {
        ...
        if (Objects.isNull(eventType)) {
            ...
            return Fn.failure(_500EventTypeNullException.class, MoveOn.class, task.getTaskDefinitionKey());
        }
        ...
        if (Objects.isNull(supplier)) {
            ...
            return Fn.failure(_404RunOnSupplierException.class, MoveOn.class, eventType);
        }
