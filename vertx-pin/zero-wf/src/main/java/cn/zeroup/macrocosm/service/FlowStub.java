...
public interface FlowStub {
    ...
    Future<JsonObject> fetchFormStart(ProcessDefinition definition, String sigma);
     ...
     */
    Future<JsonObject> fetchForm(ProcessDefinition definition, Task task, String sigma);
}
