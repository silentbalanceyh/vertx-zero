...
public interface IWTodo extends VertxPojo, Serializable {
    ...
    public default IWTodo fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setOrThrow(this::setExpiredAt, key -> {
        ...
        setOrThrow(this::setAssignedAt, key -> {
            String s = json.getString(key);
            return s == null ? null : java.time.LocalDateTime.parse(s);
        }, "ASSIGNED_AT", "java.time.LocalDateTime");
        setOrThrow(this::setAcceptedBy, json::getString, "ACCEPTED_BY", "java.lang.String");
        setOrThrow(this::setAcceptedAt, key -> {
            String s = json.getString(key);
            return s == null ? null : java.time.LocalDateTime.parse(s);
        }, "ACCEPTED_AT", "java.time.LocalDateTime");
