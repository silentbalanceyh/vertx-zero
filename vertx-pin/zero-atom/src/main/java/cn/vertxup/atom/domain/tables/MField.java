...
public class MField extends TableImpl<MFieldRecord> {
     ...
     */
    public final TableField<MFieldRecord, String> UPDATED_BY = createField("UPDATED_BY", org.jooq.impl.SQLDataType.VARCHAR(36), this, "「updatedBy」- 更新人");
    ...
    public List<UniqueKey<MFieldRecord>> getKeys() {
        return Arrays.<UniqueKey<MFieldRecord>>asList(Keys.KEY_M_FIELD_PRIMARY, Keys.KEY_M_FIELD_NAME);
    }
