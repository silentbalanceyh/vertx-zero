 ...
 *
 * - {@link io.vertx.core.json.JsonObject} content of Json Record, the core type is {@link Record}.
 * - {@link io.vertx.core.json.JsonArray} content of Json Record[], the core type is {@link Record}[].
 *
 * ### 3. Standard Mode
 *
 * #### 3.1. INTERNAL
