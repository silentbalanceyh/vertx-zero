...
public class Indexes {
    ...
    public static final Index S_VISITANT_IDXM_S_VISITANT_VIEW_ID_TYPE_CONFIG = Internal.createIndex(DSL.name("IDXM_S_VISITANT_VIEW_ID_TYPE_CONFIG"), SVisitant.S_VISITANT, new OrderField[] { SVisitant.S_VISITANT.VIEW_ID, SVisitant.S_VISITANT.TYPE, SVisitant.S_VISITANT.CONFIG_KEY }, false);
