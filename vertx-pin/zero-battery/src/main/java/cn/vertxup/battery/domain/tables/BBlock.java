...
public class BBlock extends TableImpl<BBlockRecord> {
    ...
    /**
     * The column <code>DB_ETERNAL.B_BLOCK.UI_CONTENT</code>. 「uiValue」- 配置数据
     */
    public final TableField<BBlockRecord, String> UI_CONTENT = createField(DSL.name("UI_CONTENT"), SQLDataType.CLOB, this, "「uiValue」- 配置数据");
    /**
