...
public interface IBBlock extends VertxPojo, Serializable {
    ...
    public default IBBlock fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setOrThrow(this::setSignEnd, key -> {
            String s = json.getString(key);
            return s == null ? null : java.time.LocalDateTime.parse(s);
        }, "SIGN_END", "java.time.LocalDateTime");
        setOrThrow(this::setSignStart, key -> {
            String s = json.getString(key);
            return s == null ? null : java.time.LocalDateTime.parse(s);
        }, "SIGN_START", "java.time.LocalDateTime");
