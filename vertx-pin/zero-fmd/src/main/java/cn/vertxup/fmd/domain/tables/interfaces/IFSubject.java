...
public interface IFSubject extends Serializable {
     ...
     */
    public void from(cn.vertxup.fmd.domain.tables.interfaces.IFSubject from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IFSubject
     */
    public <E extends cn.vertxup.fmd.domain.tables.interfaces.IFSubject> E into(E into);
