...
public interface IFBillItem extends Serializable {
     ...
     */
    public void from(cn.vertxup.fmd.domain.tables.interfaces.IFBillItem from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IFBillItem
     */
    public <E extends cn.vertxup.fmd.domain.tables.interfaces.IFBillItem> E into(E into);
