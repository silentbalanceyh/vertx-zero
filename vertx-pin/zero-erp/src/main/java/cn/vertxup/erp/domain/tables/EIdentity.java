...
public class EIdentity extends TableImpl<EIdentityRecord> {
    ...
    /**
     * The reference instance of <code>DB_HOTEL.E_IDENTITY</code>
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.KEY</code>. 「key」- 身份主键
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.COUNTRY</code>. 「country」- 国籍
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.NATIVE_PLACE</code>. 「nativePlace」-
     * 籍贯
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.BIRTHDAY</code>. 「birthday」- 生日
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.DRIVER_LICENSE</code>.
     * 「driverLicense」- 驾驶证
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CAR_PLATE</code>. 「carPlate」- 常用车牌
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.PASSPORT</code>. 「passport」- 护照
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.GENDER</code>. 「gender」- 性别
     */
    public final TableField<EIdentityRecord, Boolean> GENDER = createField(DSL.name("GENDER"), SQLDataType.BIT, this, "「gender」- 性别");

    /**
     * The column <code>DB_HOTEL.E_IDENTITY.MARITAL</code>. 「marital」- 婚姻状况
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CONTACT_MOBILE</code>.
     * 「contactMobile」- 联系手机
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CONTACT_PHONE</code>.
     * 「contactPhone」- 座机
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CONTACT_ADDRESS</code>.
     * 「contactAddress」- 联系地址
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CONTACT_EMAIL</code>.
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.URGENT_NAME</code>. 「urgentName」-
     * 紧急联系人
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.URGENT_PHONE</code>. 「urgentPhone」-
     * 紧急联系电话
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.EC_QQ</code>. 「ecQq」- QQ号码
     */
    public final TableField<EIdentityRecord, String> EC_QQ = createField(DSL.name("EC_QQ"), SQLDataType.VARCHAR(64), this, "「ecQq」- QQ号码");

    /**
     * The column <code>DB_HOTEL.E_IDENTITY.EC_ALIPAY</code>. 「ecAlipay」- 支付宝
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.EC_WECHAT</code>. 「ecWechat」- 微信
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_TYPE</code>. 「idcType」- 证件类型
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_NUMBER</code>. 「idcNumber」- 证件号
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_ADDRESS</code>. 「idcAddress」-
     * 证件地址
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_EXPIRED_AT</code>.
     * 「idcExpiredAt」- 证件过期时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_FRONT</code>. 「idcFront」- 证件正面附件
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_BACK</code>. 「idcBack」- 证件背面附件
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_ISSUER</code>. 「idcIssuer」-
     * 证件签发机构
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.IDC_ISSUE_AT</code>. 「idcIssueAt」-
     * 证件签发时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.VERIFIED</code>. 「verified」- 是否验证、备案
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_IDENTITY.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>DB_HOTEL.E_IDENTITY</code> table reference
     */
    ...
    /**
     * Create a <code>DB_HOTEL.E_IDENTITY</code> table reference
     */
    public EIdentity() {
