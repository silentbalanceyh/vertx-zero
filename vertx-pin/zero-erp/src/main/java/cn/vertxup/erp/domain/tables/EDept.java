...
public class EDept extends TableImpl<EDeptRecord> {
    ...
    private static final long serialVersionUID = -934156734;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.E_DEPT_CODE, Indexes.E_DEPT_IDX_E_DEPT_SIGMA, Indexes.E_DEPT_IDX_E_DEPT_SIGMA_ACTIVE, Indexes.E_DEPT_NAME, Indexes.E_DEPT_PRIMARY);
    }
