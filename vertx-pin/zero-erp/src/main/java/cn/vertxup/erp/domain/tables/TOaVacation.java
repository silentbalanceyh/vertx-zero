...
public class TOaVacation extends TableImpl<TOaVacationRecord> {
    ...
    /**
     * The reference instance of <code>DB_HOTEL.T_OA_VACATION</code>
     */
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.KEY</code>. 「key」- Ticket Primary
     * Key
     */
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.COMMENT_EXTENSION</code>.
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.REQUEST_BY</code>. 「requestBy」-
     * Request User
     */
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.CLASSIFICATION</code>.
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.START_AT</code>. 「startAt」- From
     */
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.END_AT</code>. 「endAt」- To
     */
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.DAYS</code>. 「days」- Duration
     */
    public final TableField<TOaVacationRecord, Integer> DAYS = createField(DSL.name("DAYS"), SQLDataType.INTEGER, this, "「days」- Duration");

    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.REASON</code>. 「reason」- The
     * reason to be done
     */
    ...
    /**
     * The column <code>DB_HOTEL.T_OA_VACATION.WORK_CONTENT</code>.
    ...
    /**
     * Create an aliased <code>DB_HOTEL.T_OA_VACATION</code> table reference
     */
    ...
    /**
     * Create a <code>DB_HOTEL.T_OA_VACATION</code> table reference
     */
    public TOaVacation() {
