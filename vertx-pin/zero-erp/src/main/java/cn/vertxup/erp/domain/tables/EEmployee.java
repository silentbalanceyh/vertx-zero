...
public class EEmployee extends TableImpl<EEmployeeRecord> {
    ...
    private static final long serialVersionUID = -621281646;
    /**
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.E_EMPLOYEE_IDX_E_EMPLOYEE_SIGMA, Indexes.E_EMPLOYEE_IDX_E_EMPLOYEE_SIGMA_ACTIVE, Indexes.E_EMPLOYEE_PRIMARY, Indexes.E_EMPLOYEE_WORK_NUMBER);
    }
