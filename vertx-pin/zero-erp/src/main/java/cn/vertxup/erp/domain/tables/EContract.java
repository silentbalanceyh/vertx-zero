...
public class EContract extends TableImpl<EContractRecord> {
    ...
    /**
     * The reference instance of <code>DB_HOTEL.E_CONTRACT</code>
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.KEY</code>. 「key」- 合同主键
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.TYPE</code>. 「type」-
     * 合同分类，zero.contract
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.STATUS</code>. 「status」-
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.BUDGET</code>. 「budget」-
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.LEVEL</code>. 「level」-
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.AMOUNT</code>. 「amount」- 合同金额
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.REMARK</code>. 「remark」- 合同备注
     */
    public final TableField<EContractRecord, String> REMARK = createField(DSL.name("REMARK"), SQLDataType.CLOB, this, "「remark」- 合同备注");

    /**
     * The column <code>DB_HOTEL.E_CONTRACT.PLAN_START_AT</code>. 「planStartAt」-
     * 开始日期
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.PLAN_END_AT</code>. 「planEndAt」-
     * 结束日期
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.START_AT</code>. 「startAt」- 实际开始日期
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.END_AT</code>. 「endAt」- 实际结束日期
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.SIGNED_BY</code>. 「signedBy」- 签订人
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.SIGNED_AT</code>. 「signedAt」- 签订时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.PARTY_A</code>. 「partyA」-
     * 甲方（关联公司ID，E_COMPANY）
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.PARTY_B</code>. 「partyB」-
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.A_NAME</code>. 「aName」-
     * 甲方名称（个人为姓名/企业为企业名）
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.A_PHONE</code>. 「aPhone」- 甲方电话
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.A_LEGAL</code>. 「aLegal」-
     * 甲方法人（企业合同专用）
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.A_ADDRESS</code>. 「aAddress」- 甲方地址
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.B_NAME</code>. 「bName」-
     * 乙方名称（个人为姓名/企业为企业名）
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.B_PHONE</code>. 「bPhone」- 乙方人电话
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.B_LEGAL</code>. 「bLegal」-
     * 乙方法人（企业合同专用）
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.B_ADDRESS</code>. 「bAddress」- 乙方地址
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.ACTIVE</code>. 「active」- 是否启用
     */
    public final TableField<EContractRecord, Boolean> ACTIVE = createField(DSL.name("ACTIVE"), SQLDataType.BIT, this, "「active」- 是否启用");

    /**
     * The column <code>DB_HOTEL.E_CONTRACT.SIGMA</code>. 「sigma」- 统一标识（公司所属应用）
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>DB_HOTEL.E_CONTRACT.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>DB_HOTEL.E_CONTRACT</code> table reference
     */
    ...
    /**
     * Create a <code>DB_HOTEL.E_CONTRACT</code> table reference
     */
    public EContract() {
