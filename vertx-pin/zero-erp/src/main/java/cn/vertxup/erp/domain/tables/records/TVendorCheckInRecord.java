...
public class TVendorCheckInRecord extends UpdatableRecordImpl<TVendorCheckInRecord> implements VertxPojo, Record8<String, String, String, LocalDateTime, LocalDateTime, Integer, LocalDateTime, String>, ITVendorCheckIn {
     ...
     */
    @Override
    public TVendorCheckInRecord setLeaveAt(LocalDateTime value) {
        set(6, value);
        return this;
    }
     ...
     */
    @Override
    public TVendorCheckInRecord setReason(String value) {
        set(7, value);
        return this;
    }
    ...
    public Field<LocalDateTime> field7() {
        return TVendorCheckIn.T_VENDOR_CHECK_IN.LEAVE_AT;
    }

    @Override
    public Field<String> field8() {
        return TVendorCheckIn.T_VENDOR_CHECK_IN.REASON;
    }
    ...
    @Override
    public TVendorCheckInRecord value8(String value) {
        setReason(value);
        return this;
    }

    @Override
    public TVendorCheckInRecord values(String value1, String value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, LocalDateTime value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TVendorCheckInRecord(String key, String commentExtension, String classification, LocalDateTime startAt, LocalDateTime endAt, Integer days, LocalDateTime leaveAt, String reason) {
        super(TVendorCheckIn.T_VENDOR_CHECK_IN);
