...
public class UiVisitorDao extends AbstractVertxDAO<UiVisitorRecord, cn.vertxup.ui.domain.tables.pojos.UiVisitor, Record4<String, String, String, String>, Future<List<cn.vertxup.ui.domain.tables.pojos.UiVisitor>>, Future<cn.vertxup.ui.domain.tables.pojos.UiVisitor>, Future<Integer>, Future<Record4<String, String, String, String>>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<UiVisitorRecord,cn.vertxup.ui.domain.tables.pojos.UiVisitor,Record4<String, String, String, String>> {
     ...
     */
        public UiVisitorDao(Configuration configuration, io.vertx.core.Vertx vertx) {
                super(UiVisitor.UI_VISITOR, cn.vertxup.ui.domain.tables.pojos.UiVisitor.class, new JDBCClassicQueryExecutor<UiVisitorRecord,cn.vertxup.ui.domain.tables.pojos.UiVisitor,Record4<String, String, String, String>>(configuration,cn.vertxup.ui.domain.tables.pojos.UiVisitor.class,vertx));
        }

        @Override
        protected Record4<String, String, String, String> getId(cn.vertxup.ui.domain.tables.pojos.UiVisitor object) {
                return compositeKeyRecord(object.getIdentifier(), object.getPage(), object.getPath(), object.getSigma());
        }
     ...
     */
        ...
        @Override
        public JDBCClassicQueryExecutor<UiVisitorRecord,cn.vertxup.ui.domain.tables.pojos.UiVisitor,Record4<String, String, String, String>> queryExecutor(){
                return (JDBCClassicQueryExecutor<UiVisitorRecord,cn.vertxup.ui.domain.tables.pojos.UiVisitor,Record4<String, String, String, String>>) super.queryExecutor();
        }
}
