...
public interface IVTable extends Serializable {
     ...
     */
    public void from(cn.vertxup.ui.domain.tables.interfaces.IVTable from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IVTable
     */
    public <E extends cn.vertxup.ui.domain.tables.interfaces.IVTable> E into(E into);

    default IVTable fromJson(io.vertx.core.json.JsonObject json) {
        setKey(json.getString("KEY"));
        setBordered(json.getBoolean("BORDERED"));
        setSize(json.getString("SIZE"));
        setClassName(json.getString("CLASS_NAME"));
        setTotalReport(json.getString("TOTAL_REPORT"));
        setTotalSelected(json.getString("TOTAL_SELECTED"));
        setRowDoubleClick(json.getString("ROW_DOUBLE_CLICK"));
        setRowClick(json.getString("ROW_CLICK"));
        setRowContextMenu(json.getString("ROW_CONTEXT_MENU"));
        setRowMouseEnter(json.getString("ROW_MOUSE_ENTER"));
        setRowMouseLeave(json.getString("ROW_MOUSE_LEAVE"));
        setOpTitle(json.getString("OP_TITLE"));
        setOpDataIndex(json.getString("OP_DATA_INDEX"));
        setOpFixed(json.getBoolean("OP_FIXED"));
        setOpConfig(json.getString("OP_CONFIG"));
        return this;
    }
