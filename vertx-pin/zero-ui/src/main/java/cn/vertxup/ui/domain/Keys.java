...
public class Keys {
    ...
    public static final UniqueKey<UiListQrRecord> KEY_UI_LIST_QR_PRIMARY = Internal.createUniqueKey(UiListQr.UI_LIST_QR, DSL.name("KEY_UI_LIST_QR_PRIMARY"), new TableField[] { UiListQr.UI_LIST_QR.KEY }, true);
    public static final UniqueKey<UiListQrRecord> KEY_UI_LIST_QR_SIGMA = Internal.createUniqueKey(UiListQr.UI_LIST_QR, DSL.name("KEY_UI_LIST_QR_SIGMA"), new TableField[] { UiListQr.UI_LIST_QR.SIGMA, UiListQr.UI_LIST_QR.CODE, UiListQr.UI_LIST_QR.NAME }, true);
    public static final UniqueKey<UiListQrRecord> KEY_UI_LIST_QR_SIGMA_2 = Internal.createUniqueKey(UiListQr.UI_LIST_QR, DSL.name("KEY_UI_LIST_QR_SIGMA_2"), new TableField[] { UiListQr.UI_LIST_QR.SIGMA, UiListQr.UI_LIST_QR.CODE, UiListQr.UI_LIST_QR.VIEW, UiListQr.UI_LIST_QR.POSITION }, true);
