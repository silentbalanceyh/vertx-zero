...
public class FSubject extends TableImpl<FSubjectRecord> {
     ...
     */
    public final TableField<FSubjectRecord, String> SERIAL = createField("SERIAL", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "「serial」 - 会计科目编号");
    /**
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.F_SUBJECT_CODE, Indexes.F_SUBJECT_PRIMARY, Indexes.F_SUBJECT_SERIAL);
    }
    ...
    public List<UniqueKey<FSubjectRecord>> getKeys() {
        return Arrays.<UniqueKey<FSubjectRecord>>asList(Keys.KEY_F_SUBJECT_PRIMARY, Keys.KEY_F_SUBJECT_CODE, Keys.KEY_F_SUBJECT_SERIAL);
    }
