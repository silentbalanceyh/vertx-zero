...
public class FDebtItem implements VertxPojo, IFDebtItem {
    ...
    public FDebtItem(IFDebtItem value) {
    ...
    public FDebtItem(
        ...
        public FDebtItem(io.vertx.core.json.JsonObject json) {
                this();
                fromJson(json);
        }
     ...
     */
    @Override
    public FDebtItem setKey(String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setName(String name) {
        this.name = name;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setCode(String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setSerial(String serial) {
        this.serial = serial;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setAmount(BigDecimal amount) {
        this.amount = amount;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setDebtId(String debtId) {
        this.debtId = debtId;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setPaymentId(String paymentId) {
        this.paymentId = paymentId;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setSigma(String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setLanguage(String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setActive(Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setMetadata(String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setCreatedAt(LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setUpdatedAt(LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public FDebtItem setUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("FDebtItem (");
