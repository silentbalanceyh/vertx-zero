...
public class Keys {
    ...
    public static final UniqueKey<FDebtItemRecord> KEY_F_DEBT_ITEM_CODE = Internal.createUniqueKey(FDebtItem.F_DEBT_ITEM, DSL.name("KEY_F_DEBT_ITEM_CODE"), new TableField[] { FDebtItem.F_DEBT_ITEM.CODE, FDebtItem.F_DEBT_ITEM.SIGMA }, true);
    public static final UniqueKey<FDebtItemRecord> KEY_F_DEBT_ITEM_PRIMARY = Internal.createUniqueKey(FDebtItem.F_DEBT_ITEM, DSL.name("KEY_F_DEBT_ITEM_PRIMARY"), new TableField[] { FDebtItem.F_DEBT_ITEM.KEY }, true);
    public static final UniqueKey<FDebtItemRecord> KEY_F_DEBT_ITEM_SERIAL = Internal.createUniqueKey(FDebtItem.F_DEBT_ITEM, DSL.name("KEY_F_DEBT_ITEM_SERIAL"), new TableField[] { FDebtItem.F_DEBT_ITEM.SERIAL, FDebtItem.F_DEBT_ITEM.SIGMA }, true);
