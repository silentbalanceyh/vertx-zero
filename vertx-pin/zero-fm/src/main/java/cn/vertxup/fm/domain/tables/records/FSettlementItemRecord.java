...
public class FSettlementItemRecord extends UpdatableRecordImpl<FSettlementItemRecord> implements VertxPojo, Record19<String, String, String, String, BigDecimal, String, String, String, String, String, String, String, String, Boolean, String, LocalDateTime, String, LocalDateTime, String>, IFSettlementItem {
    ...
    public FSettlementItemRecord(cn.vertxup.fm.domain.tables.pojos.FSettlementItem value) {
        ...
        if (value != null) {
            ...
            setReceivableId(value.getReceivableId());
