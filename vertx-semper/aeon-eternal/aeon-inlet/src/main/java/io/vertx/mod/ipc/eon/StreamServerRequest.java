...
/**
 * Protobuf type {@code io.vertx.mod.ipc.eon.StreamServerRequest}
 */
public final class StreamServerRequest extends
                ...
                switch (tag) {
                    ...
                    case 18: {
                        if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                            responseParams_ = new java.util.ArrayList<io.vertx.mod.ipc.eon.ResponseParams>();
                            mutable_bitField0_ |= 0x00000002;
                        }
                        responseParams_.add(
                            input.readMessage(io.vertx.mod.ipc.eon.ResponseParams.parser(), extensionRegistry));
                        break;
                    }
                    case 26: {
                        ...
                        envelop_ = input.readMessage(io.vertx.mod.ipc.eon.IpcEnvelop.parser(), extensionRegistry);
                        if (subBuilder != null) {
                    ...
                    case 42: {
                        ...
                        responseStatus_ = input.readMessage(io.vertx.mod.ipc.eon.IpcStatus.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    getDescriptor() {
        return io.vertx.mod.ipc.eon.UpStream.internal_static_io_vertx_tp_ipc_eon_StreamServerRequest_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    internalGetFieldAccessorTable() {
        return io.vertx.mod.ipc.eon.UpStream.internal_static_io_vertx_tp_ipc_eon_StreamServerRequest_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                io.vertx.mod.ipc.eon.StreamServerRequest.class, io.vertx.mod.ipc.eon.StreamServerRequest.Builder.class);
    }
     ...
     * <code>.io.vertx.mod.ipc.eon.em.Format response_type = 1;</code>
     */
    public io.vertx.mod.ipc.eon.em.Format getResponseType() {
        io.vertx.mod.ipc.eon.em.Format result = io.vertx.mod.ipc.eon.em.Format.valueOf(responseType_);
    ...
    private java.util.List<io.vertx.mod.ipc.eon.ResponseParams> responseParams_;

    /**
     * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
     */
    public java.util.List<io.vertx.mod.ipc.eon.ResponseParams> getResponseParamsList() {
     ...
     * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
     */
    public java.util.List<? extends io.vertx.mod.ipc.eon.ResponseParamsOrBuilder>
     ...
     * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
     */
    public io.vertx.mod.ipc.eon.ResponseParams getResponseParams(int index) {
     ...
     * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
     */
    public io.vertx.mod.ipc.eon.ResponseParamsOrBuilder getResponseParamsOrBuilder(
        int index) {
        return responseParams_.get(index);
    }
    ...
    public io.vertx.mod.ipc.eon.IpcEnvelop getEnvelop() {
        return envelop_ == null ? io.vertx.mod.ipc.eon.IpcEnvelop.getDefaultInstance() : envelop_;
    }
    ...
    private io.vertx.mod.ipc.eon.IpcStatus responseStatus_;
    ...
    public io.vertx.mod.ipc.eon.IpcStatus getResponseStatus() {
        return responseStatus_ == null ? io.vertx.mod.ipc.eon.IpcStatus.getDefaultInstance() : responseStatus_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (responseType_ != io.vertx.mod.ipc.eon.em.Format.BINARY.getNumber()) {
        ...
        if (algorithm_ != io.vertx.mod.ipc.eon.em.Compression.NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof io.vertx.mod.ipc.eon.StreamServerRequest)) {
            return super.equals(obj);
        }
        io.vertx.mod.ipc.eon.StreamServerRequest other = (io.vertx.mod.ipc.eon.StreamServerRequest) obj;
    ...
    public static io.vertx.mod.ipc.eon.StreamServerRequest parseFrom(
    ...
    public static io.vertx.mod.ipc.eon.StreamServerRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static io.vertx.mod.ipc.eon.StreamServerRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static io.vertx.mod.ipc.eon.StreamServerRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
    }

    public static io.vertx.mod.ipc.eon.StreamServerRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(io.vertx.mod.ipc.eon.StreamServerRequest prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:io.vertx.mod.ipc.eon.StreamServerRequest)
        io.vertx.mod.ipc.eon.StreamServerRequestOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
            return io.vertx.mod.ipc.eon.UpStream.internal_static_io_vertx_tp_ipc_eon_StreamServerRequest_descriptor;
        }
        ...
        // Construct using io.vertx.mod.ipc.eon.StreamServerRequest.newBuilder()
        private Builder() {
        ...
        public io.vertx.mod.ipc.eon.StreamServerRequest getDefaultInstanceForType() {
            return io.vertx.mod.ipc.eon.StreamServerRequest.getDefaultInstance();
        }

        public io.vertx.mod.ipc.eon.StreamServerRequest build() {
            io.vertx.mod.ipc.eon.StreamServerRequest result = buildPartial();
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof io.vertx.mod.ipc.eon.StreamServerRequest) {
                return mergeFrom((io.vertx.mod.ipc.eon.StreamServerRequest) other);
            } else {
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
            io.vertx.mod.ipc.eon.StreamServerRequest parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (io.vertx.mod.ipc.eon.StreamServerRequest) e.getUnfinishedMessage();
         ...
         * <code>.io.vertx.mod.ipc.eon.em.Format response_type = 1;</code>
         */
        public Builder setResponseType(io.vertx.mod.ipc.eon.em.Format value) {
            if (value == null) {
        ...
        private void ensureResponseParamsIsMutable() {
            if (!((bitField0_ & 0x00000002) == 0x00000002)) {
                responseParams_ = new java.util.ArrayList<io.vertx.mod.ipc.eon.ResponseParams>(responseParams_);
                bitField0_ |= 0x00000002;
            }
        }

        private com.google.protobuf.RepeatedFieldBuilderV3<
            io.vertx.mod.ipc.eon.ResponseParams, io.vertx.mod.ipc.eon.ResponseParams.Builder, io.vertx.mod.ipc.eon.ResponseParamsOrBuilder> responseParamsBuilder_;
        ...
        public Builder setResponseParams(
            int index, io.vertx.mod.ipc.eon.ResponseParams value) {
            if (responseParamsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         */
        public Builder setResponseParams(
            int index, io.vertx.mod.ipc.eon.ResponseParams.Builder builderForValue) {
            if (responseParamsBuilder_ == null) {
                ensureResponseParamsIsMutable();
         ...
         * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
         */
        public Builder addResponseParams(io.vertx.mod.ipc.eon.ResponseParams value) {
            if (responseParamsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         */
        public Builder addResponseParams(
            io.vertx.mod.ipc.eon.ResponseParams.Builder builderForValue) {
            if (responseParamsBuilder_ == null) {
                ensureResponseParamsIsMutable();
        ...
        public Builder addAllResponseParams(
            java.lang.Iterable<? extends io.vertx.mod.ipc.eon.ResponseParams> values) {
            if (responseParamsBuilder_ == null) {
                ensureResponseParamsIsMutable();
         ...
         * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
         */
        public io.vertx.mod.ipc.eon.ResponseParams.Builder getResponseParamsBuilder(
            int index) {
         ...
         * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
         */
        public io.vertx.mod.ipc.eon.ResponseParams.Builder addResponseParamsBuilder() {
            return getResponseParamsFieldBuilder().addBuilder(
                io.vertx.mod.ipc.eon.ResponseParams.getDefaultInstance());
        }
        ...
        public io.vertx.mod.ipc.eon.ResponseParams.Builder addResponseParamsBuilder(
            int index) {
            return getResponseParamsFieldBuilder().addBuilder(
                index, io.vertx.mod.ipc.eon.ResponseParams.getDefaultInstance());
        }

        /**
         * <code>repeated .io.vertx.mod.ipc.eon.ResponseParams response_params = 2;</code>
         */
        public java.util.List<io.vertx.mod.ipc.eon.ResponseParams.Builder>
        getResponseParamsBuilderList() {
            return getResponseParamsFieldBuilder().getBuilderList();
        }

        private com.google.protobuf.RepeatedFieldBuilderV3<
            io.vertx.mod.ipc.eon.ResponseParams, io.vertx.mod.ipc.eon.ResponseParams.Builder, io.vertx.mod.ipc.eon.ResponseParamsOrBuilder>
        getResponseParamsFieldBuilder() {
            if (responseParamsBuilder_ == null) {
         ...
         * <code>.io.vertx.mod.ipc.eon.IpcEnvelop envelop = 3;</code>
         */
        public Builder setEnvelop(io.vertx.mod.ipc.eon.IpcEnvelop value) {
            if (envelopBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public io.vertx.mod.ipc.eon.IpcEnvelopOrBuilder getEnvelopOrBuilder() {
            if (envelopBuilder_ != null) {
                ...
                return envelop_ == null ?
                    io.vertx.mod.ipc.eon.IpcEnvelop.getDefaultInstance() : envelop_;
            }
        }
         ...
         * <code>.io.vertx.mod.ipc.eon.em.Compression algorithm = 4;</code>
         */
        public Builder setAlgorithm(io.vertx.mod.ipc.eon.em.Compression value) {
            if (value == null) {
                throw new NullPointerException();
            }
        ...
        private io.vertx.mod.ipc.eon.IpcStatus responseStatus_ = null;
        private com.google.protobuf.SingleFieldBuilderV3<
            io.vertx.mod.ipc.eon.IpcStatus, io.vertx.mod.ipc.eon.IpcStatus.Builder, io.vertx.mod.ipc.eon.IpcStatusOrBuilder> responseStatusBuilder_;
         ...
         * <code>.io.vertx.mod.ipc.eon.IpcStatus response_status = 5;</code>
         */
        public Builder setResponseStatus(io.vertx.mod.ipc.eon.IpcStatus value) {
            if (responseStatusBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public Builder setResponseStatus(
            io.vertx.mod.ipc.eon.IpcStatus.Builder builderForValue) {
            if (responseStatusBuilder_ == null) {
         ...
         * <code>.io.vertx.mod.ipc.eon.IpcStatus response_status = 5;</code>
         */
        public Builder mergeResponseStatus(io.vertx.mod.ipc.eon.IpcStatus value) {
            if (responseStatusBuilder_ == null) {
                if (responseStatus_ != null) {
                    responseStatus_ =
                        io.vertx.mod.ipc.eon.IpcStatus.newBuilder(responseStatus_).mergeFrom(value).buildPartial();
                } else {
                    responseStatus_ = value;
                }
                onChanged();
         ...
         * <code>.io.vertx.mod.ipc.eon.IpcStatus response_status = 5;</code>
         */
        public io.vertx.mod.ipc.eon.IpcStatus.Builder getResponseStatusBuilder() {
        ...
        public io.vertx.mod.ipc.eon.IpcStatusOrBuilder getResponseStatusOrBuilder() {
            if (responseStatusBuilder_ != null) {
                ...
                return responseStatus_ == null ?
                    io.vertx.mod.ipc.eon.IpcStatus.getDefaultInstance() : responseStatus_;
            }
        }
        ...
        // @@protoc_insertion_point(builder_scope:io.vertx.mod.ipc.eon.StreamServerRequest)
    }

    // @@protoc_insertion_point(class_scope:io.vertx.mod.ipc.eon.StreamServerRequest)
    private static final io.vertx.mod.ipc.eon.StreamServerRequest DEFAULT_INSTANCE;

    static {
        DEFAULT_INSTANCE = new io.vertx.mod.ipc.eon.StreamServerRequest();
    }

    public static io.vertx.mod.ipc.eon.StreamServerRequest getDefaultInstance() {
