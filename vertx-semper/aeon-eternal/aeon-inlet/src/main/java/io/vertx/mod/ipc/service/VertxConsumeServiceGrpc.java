...
public final class VertxConsumeServiceGrpc {
    ...
    public static final class ConsumeServiceVertxStub extends io.grpc.stub.AbstractStub<ConsumeServiceVertxStub> {
         ...
         * </pre>
         */
        public io.vertx.core.streams.ReadStream<io.vertx.mod.ipc.eon.StreamServerResponse> outputCall(io.vertx.core.Handler<io.vertx.core.streams.WriteStream<io.vertx.mod.ipc.eon.StreamServerRequest>> hdlr) {
    ...
    public static abstract class ConsumeServiceVertxImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public void outputCall(io.vertx.core.streams.ReadStream<io.vertx.mod.ipc.eon.StreamServerRequest> request, io.vertx.core.streams.WriteStream<io.vertx.mod.ipc.eon.StreamServerResponse> response) {
