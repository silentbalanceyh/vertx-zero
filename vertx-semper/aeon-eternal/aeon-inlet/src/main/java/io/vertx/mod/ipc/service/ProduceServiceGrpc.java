...
public final class ProduceServiceGrpc {
    ...
    public static final String SERVICE_NAME = "io.vertx.mod.ipc.service.ProduceService";
    // Static method descriptors that strictly reflect the proto.
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
    public static final io.grpc.MethodDescriptor<io.vertx.mod.ipc.eon.StreamClientRequest,
        io.vertx.mod.ipc.eon.StreamClientResponse> METHOD_INPUT_CALL =
        io.grpc.MethodDescriptor.<io.vertx.mod.ipc.eon.StreamClientRequest, io.vertx.mod.ipc.eon.StreamClientResponse>newBuilder()
            .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
            .setFullMethodName(generateFullMethodName(
                "io.vertx.mod.ipc.service.ProduceService", "InputCall"))
            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                io.vertx.mod.ipc.eon.StreamClientRequest.getDefaultInstance()))
            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                io.vertx.mod.ipc.eon.StreamClientResponse.getDefaultInstance()))
            .build();
    ...
    public static abstract class ProduceServiceImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public io.grpc.stub.StreamObserver<io.vertx.mod.ipc.eon.StreamClientRequest> inputCall(
