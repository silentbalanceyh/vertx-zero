...
public final class VertxDupliexServiceGrpc {
    ...
    public static final class DupliexServiceVertxStub extends io.grpc.stub.AbstractStub<DupliexServiceVertxStub> {
         ...
         * </pre>
         */
        public io.vertx.core.streams.ReadStream<io.vertx.mod.ipc.eon.StreamServerResponse> dupliexCall(io.vertx.core.Handler<io.vertx.core.streams.WriteStream<io.vertx.mod.ipc.eon.StreamClientRequest>> hdlr) {
    ...
    public static abstract class DupliexServiceVertxImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public void dupliexCall(io.vertx.core.streams.ReadStream<io.vertx.mod.ipc.eon.StreamClientRequest> request, io.vertx.core.streams.WriteStream<io.vertx.mod.ipc.eon.StreamServerResponse> response) {
