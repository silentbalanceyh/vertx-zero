...
public class JacksonTc extends ZeroBase {
    ...
    public void testvJson(final TestContext context) {
        final JsonObject data = IO.getJObject(this.ioString("jackson-testInt.json"));
    ...
    public void testMerge(final TestContext context) {
        final JsonArray fromData = IO.getJArray(this.ioString("from.json"));
        final JsonArray toData = IO.getJArray(this.ioString("to.json"));
    ...
    public void testSerializer(final TestContext context) {
        final JsonObject data = IO.getJObject(this.ioString("jackson-json.json"));
