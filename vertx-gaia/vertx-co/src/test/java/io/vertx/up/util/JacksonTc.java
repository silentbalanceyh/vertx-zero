...
public class JacksonTc extends ZeroBase {
    ...
    public void testvJson(final TestContext context) {
        final JsonObject data = IO.getJObject(this.ioFile("jackson-testInt.json"));
    ...
    public void testMerge(final TestContext context) {
        final JsonArray fromData = IO.getJArray(this.ioFile("from.json"));
        final JsonArray toData = IO.getJArray(this.ioFile("to.json"));
