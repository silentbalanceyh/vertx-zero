...
class Format {
    ...
    private static final int COLOR_BLANK = 30;
    ...
    static String color(final String flag, final int color, final boolean bold) {
    ...
    static String formatBold(final String message, final Object... args) {
        if (0 < args.length) {
            return BOLD_FLAG + MessageFormat.format(message, args);
        } else {
