...
public class V {
    ...
    private static final Cc<String, Vto> CC_VTO = Cc.open();

    public static Vto vInstant() {
        return CC_VTO.pick(InstantVto::new, InstantVto.class);
    ...
    public static Vto vDate() {
        return CC_VTO.pick(DateVto::new, DateVto.class);
