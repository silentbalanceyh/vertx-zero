...
import io.vertx.up.error.shell.CommandParseException;
import io.vertx.up.error.shell.CommandUnknownException;
import io.vertx.up.error.shell.PluginMissingException;
