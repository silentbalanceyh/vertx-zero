...
var AntdPlugin = function () {
  function AntdPlugin(libraryName, libraryDirectory, style, types) {
    _classCallCheck(this, AntdPlugin);
  ...
  _createClass(AntdPlugin, [{
    ...
    value: function ExportDefaultDeclaration(path, _ref9) {
      var opts = _ref9.opts;
      var node = path.node;
